...
export class FilledDoc {
    //refactor 6: items passou a ser uma lista de strings.
    items: string[] | undefined;

    //refactor 7: o item selecionado passa a ser uma string.
    selectedItem: string | undefined;

    //refactor 8: as sugestões agora são um array de strings.
